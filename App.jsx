      ...
      {tab==="home" && (
        <div>
          ...
          <div style={{position:"relative", borderRadius:"20px", overflow:"hidden", marginBottom:"20px"}}>
            ...
            {/* 업로드 버튼 - 눈에 보이게 */}
            <label style={{position:"absolute", top:"10px", right:"10px", background:"#ff8fa3", color:"#fff", padding:"10px 15px", borderRadius:"12px", cursor:"pointer", fontWeight:"bold", boxShadow:"0 4px 10px rgba(0,0,0,0.2)"}}>
              사진 추가
